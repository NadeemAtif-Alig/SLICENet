...
def train(args, train_loader, model, criterion, optimizer, epoch):
    ...
    for iteration, batch in enumerate(train_loader, 0):
        ...
        #print("size of training images", images.shape) ###################################
...
def train_model(args):
    ...
    args.savedir = (args.savedir + args.dataset + '/' + args.model + '-' + args.filename + '-bs'
                    + str(args.batch_size) + "-" + str(args.train_type) + '/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', default="248-base", help="model name: Context Guided Network (CGNet)")
    parser.add_argument('--model', default="slicenet", help="model name: Hierarchically Aggregated Narrow Dilated Network (HANDNet)")
    parser.add_argument('--dataset', default="cityscapes", help="dataset: cityscapes or camvid")
    parser.add_argument('--train_type', type=str, default="train", help="train or trainval or trainvaltest")
    parser.add_argument('--max_epochs', type=int, default=1000, help="the number of epochs: 300 for train set, 350 for train+val set")
    ...
    parser.add_argument('--resume', type=str, default="h", help="use this file to load last checkpoint for continuing training")
    parser.add_argument('--classes', type=int, default=19, help="the number of classes. 19 and 11 for cityscapes and camvid, respectively")
